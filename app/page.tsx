      ...
      <div className="container mx-auto  h-full">
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            <span className="text-4xl text-accent">Softwear Developer!!</span>
            <br />
            <br />
...
<Button variant="outline" size="lg" className="uppercase flex items-center gap-3">
  <a href="/CV.pdf.pdf"><span className="flex gap-4">Download CV<FiDownload className="text-xl"/></span></a>
  </Button>
  ...
  <Link href= "https://github.com/faryal16" className="Link">  <FaGithub  /> </Link>
    ...
    <Link href="https://www.youtube.com/@poetrylover4451" className="Link"> <FaYoutube /></Link>  
  </div>
</div>
